...
1. $\vec{E}$ is tangent to the field line at every point.
2. A higher density of lines corresponds to a greater magnitude of $\vec{E}$.
	Specifically the density of lines in a plane perpendicular to a line is related to the magnitude in that area.
